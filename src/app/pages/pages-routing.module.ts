...
import { MstCauselistComponent } from './mst-causelist/mst-causelist.component';
import { MstOrderJudgementComponent } from './mst-order-judgement/mst-order-judgement.component';
import { PublicFeedbackComponent } from './public-feedback/public-feedback.component';
import { InterimOrderComponent } from './interim-order/interim-order.component';
...
const routes: Routes = [{
    ...
    children: [{
        ...
        path: 'cause-list',
        component: MstCauselistComponent
    }, {
        path: 'order-judgement',
        component: MstOrderJudgementComponent
    }, {
        path: 'public-feedback',
        component: PublicFeedbackComponent
    }, {
        path: 'interim-order',
        component: InterimOrderComponent
    }, {
